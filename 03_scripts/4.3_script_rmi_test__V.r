### Skript 4.3 ### Kara Hass, Bachelor-Arbeit, 2023
# Skript 3.3_script_rmi_read_in_data_V muss durchgelaufen sein, vor Run dieses Skripts
# RMI-Permutationstest nur Vorbedingung V
...
# 13.1 Arbeitsverzeichnis
setwd('C:/Users/Kaks/Documents/Studium/Psychologie/PSY_B_K Forschungskolloquium/01_perm')

# 13.2 tmax Statistik Funktion uebernommen von Gondan & Minakata 2015
...
# 13.3 Der Signifikanztest - Permutationstest
#
...
# 13.4 Daten einlesen aus txt-Datei
#
# Obs: Observer (= Vp)
...
# 13.5 Anwendung Permutationstest auf Datensatz

data_p_V = rmiread("perm_data_V_23_03_06.txt")
rmiperm(data_p_V)