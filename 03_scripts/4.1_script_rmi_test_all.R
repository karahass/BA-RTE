### Skript 4.1 ### Kara Hass, Bachelor-Arbeit, 2023
# Skript 3.1_script_rmi_read_in_data muss durchgelaufen sein, vor Run dieses Skripts
# RMI-Permutationstest gesamter Datensatz
...
# 11.1 Arbeitsverzeichnis
setwd('C:/Users/Kaks/Documents/Studium/Psychologie/PSY_B_K Forschungskolloquium/01_perm')

# 11.2 tmax Statistik Funktion uebernommen von Gondan & Minakata 2016
...
# 11.3 Der Signifikanztest - Permutationstest
#
...
# 11.4 Daten einlesen aus txt-Datei
#
# Obs: Observer (= Vp)
...
# 11.5 Anwendung Permutationstest auf Datensatz
