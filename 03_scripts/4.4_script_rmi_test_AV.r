### Skript 4.4 ### Kara Hass, Bachelor-Arbeit, 2023
# Skript 3.4_script_rmi_read_in_data_AV muss durchgelaufen sein, vor Run dieses Skripts
# RMI-Permutationstest nur Vorbedingung AV
...
# 14.1 Arbeitsverzeichnis
setwd('C:/Users/Kaks/Documents/Studium/Psychologie/PSY_B_K Forschungskolloquium/01_perm')

# 14.2 tmax Statistik Funktion uebernommen von Gondan & Minakata 2015
...
# 14.3 Der Signifikanztest - Permutationstest
#
...
# 14.4 Daten einlesen aus txt-Datei
#
# Obs: Observer (= Vp)
...
# Obs Cond   RT  # Diese Üeberschriften sollten vorhanden sein
...
# 14.5 Anwendung Permutationstest auf Datensatz

data_p_AV = rmiread("perm_data_AV.txt")
rmiperm(data_p_AV)